...
class CrashMonitor {
  ...
  private initializeMonitoring() {
    ...
    // Silent initialization - critical crashes will be sent via email in production only
  }
  ...
  // Removed localStorage persistence - critical reports are sent via email
  ...
  private async sendReportToService(report: CrashReport) {
    ...
    try {
      // Only send in production and only for critical errors
  ...
  // Removed console logging - critical reports are sent via email silently
  ...
  public clearReports() {
    this.reportQueue = [];
    // No localStorage to clear - critical reports are sent via email
  }
