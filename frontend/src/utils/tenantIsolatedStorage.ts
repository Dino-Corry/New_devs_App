...
export class TenantIsolatedStorage {
  ...
  set<T>(key: string, value: T, options: Partial<CacheOptions> = {}): boolean {
    ...
    const cacheOptions: CacheOptions = {
      ...
      skipTenantValidation: isSystem, // System keys can bypass tenant validation
      ...options
    };
  ...
  /**
   * Emergency nuclear clear (all tenants, all data)
   */
  ...
  /**
   * Reset storage (for testing or emergency)
   */
  reset(): void {
