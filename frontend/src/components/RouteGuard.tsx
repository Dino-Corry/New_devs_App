...
export default function RouteGuard({ 
  ...
  // CRITICAL FIX: Remove checkState from dependencies to prevent infinite loop
  const performCheck = useCallback(async () => {
    ...
    // CRITICAL FIX: Wait for ALL async operations to complete before checking
  ...
  useEffect(() => {
    ...
    // CRITICAL: Only perform check when BOTH auth AND permissions are fully loaded
