      ...
      try {
            ...
            if (bestKey) {
              ...
              if (!cancelled) {
                ...
                if (tidFromData) {
                  ...
                  // 🚨 EMERGENCY FIX: Apply same override for bootstrap data
                  ...
                  // Apply emergency override if user needs it
        ...
        if (shouldForceRefresh) {
          ...
          if (me) {
            ...
            // ✅ CRITICAL FIX: Prioritize JWT tenant ID over /me endpoint response
            ...
            if (!cancelled) {
              ...
              // 🚨 EMERGENCY FIX: Override for specific users with known correct tenant
              ...
              // Log potential conflict for debugging
