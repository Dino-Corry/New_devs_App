...
export async function uploadImage(
  ...
  try {
    ...
    // Use adminClient for storage operations to bypass RLS
 ...
 * This function calls the backend API to bypass CORS restrictions
...
export async function deleteLocationImage(photoUrl: string): Promise<boolean> {
  try {
    ...
    // Example URL: https://xxx.supabase.co/storage/v1/object/public/nearby-location-photos/nearby-locations/place_123_456.jpg
